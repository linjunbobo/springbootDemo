package com.exampe.demo.RabbitMQ;
...
//    }
//    @RabbitHandler
//    @RabbitListener(queues = "ljbQueue")//监听的队列名称 ljbQueues
//    public void ljbQueuesRec(Map testMessage) {
//        System.out.println("DirectReceiver消费者收到消息(ljbQueue)  : " + testMessage.toString());
//    }
